...
class RedisNotVisitUrl(BaseDupeFilter):
    def __init__(self, server,
                 key=defaults.NOT_VISIT_URL_KEY,
    ...
    def from_spider(cls, spider):
        ...
        not_visit_key = settings.get("SCHEDULER_NOT_VISIT_KEY", defaults.SCHEDULER_NOT_VISIT_KEY)
